...
namespace app {
    ...
    void GuiController::draw() {
        ...
        auto post_processing = engine::core::Controller::get<PostProcessingController>();
        ...
        float vignette_strength = post_processing->vignette_strength();
        if (ImGui::SliderFloat("Vignette strength", &vignette_strength, 0.0f, 1.0f)) {
            post_processing->set_vignette_strength(vignette_strength);
        }
